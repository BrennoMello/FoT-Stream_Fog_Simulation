...
class HDDM_A_test(SuperDetector):
    ...
    def run(self, pr):
        ...
        cota = math.sqrt(
            (1.0 / (2 * self.n_min)) * math.log(1.0 / self.drift_confidence, math.e)
        )
        cota1 = math.sqrt(
            (1.0 / (2 * self.total_n)) * math.log(1.0 / self.drift_confidence, math.e)
        )
        ...
        cota = math.sqrt(
            (1.0 / (2 * self.n_max)) * math.log(1.0 / self.drift_confidence, math.e)
        )
